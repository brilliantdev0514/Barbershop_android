                ...
                .addOnCompleteListener(VerifyPhoneActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Client mClient = new Client(userId, currentPhoneNumber, currentUserName, "null", "null", 0, false);
                            mRef.setValue(mClient);
                            //
                            ...
                            editor.putString(sharedPrefKey, "CLIENT");
                            editor.putString("myname", currentUserName);
                            editor.commit();
                            //
                            Intent intent = new Intent(VerifyPhoneActivity.this, ClientActivity.class);
